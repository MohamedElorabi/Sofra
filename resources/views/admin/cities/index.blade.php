...
<section class="content">
  ...
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">@lang('lang.List of Cities')</h3>


    </div>
    <div class="box-body">
      <a href="{{url('admin/cities/create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('lang.Create City')</a>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                  <a href="cities/{{$record->id}}/edit" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
              </td>
              <td class="text-center">
                {!! Form::open([
