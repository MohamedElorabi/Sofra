...
<section class="content">
  ...
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">@lang('lang.List of Blocks')</h3>


    </div>
    <div class="box-body">
      <a href="{{url('admin/blocks/create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('lang.Create Blocks')</a>
        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              <th class="text-center">@lang('lang.Block Name')</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                  <a href="{{url(route('blocks.edit' , $record->id))}}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
              </td>
              <td class="text-center">
                {!! Form::open([
