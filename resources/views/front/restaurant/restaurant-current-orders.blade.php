...
<section class="orders">
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <a class="nav-item nav-link active" href="{{url('restaurant-current-orders')}}">
                    <h3>طلبات جديدة</h3>
                </a>
                ...
                <div class="col-6 media">
                    ...
                    <div class="media-body">
                        ...
                        <div class="button-orders mt-5">
                            <button class="phone h6 btn btn-lg px-5"><a href="#">0123886789</a></button>
                            <button class="confirm h6 btn btn-lg px-5"><a href="{{url('restaurant-delivered',$record->id)}}">تأكيد التسليم</a></button>
                        </div>
                        <!--button-orders-->
                    </div>
                    <!--media-body-->
